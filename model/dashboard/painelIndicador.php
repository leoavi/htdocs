...
<div class="<?php echo $colGrid; ?> item chrt-page-grids">
      ...
      <div class="panel-heading">
          ...
          <a onClick="window.location.reload();return false;" class="mobileHide"  id="atualizar<?php echo $handleComponente; ?>"><i class="fa fa-retweet"></i></a>      </div>
      
      <div class="panel-body" id="painel<?php echo $handleComponente; ?>">
<?php
include('../../controller/dashboard/painelIndicadorController.php');
?>
...
$("a#fechar<?php echo $handleComponente; ?>").click(function(){
	if( !$("div#painel<?php echo $handleComponente; ?>").hasClass("display") ){
		...
		$("i#iconeFechar<?php echo $handleComponente; ?>").removeClass("fa-times").addClass("fa-window-restore");
	}
	else{
		...
		$("i#iconeFechar<?php echo $handleComponente; ?>").removeClass("fa-window-restore").addClass("fa-times");
	}
});

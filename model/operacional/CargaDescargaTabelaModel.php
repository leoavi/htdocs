...
$queryCargaDescarga = "                     SELECT DISTINCT TOP 1000
                                                   A.HANDLE HANDLE,  
                                                   A.STATUS STATUS, 
						   A.NUMERO NUMERO,
...
if ($filtraUsuario) {
    $queryCargaDescarga .= $wherePessoasUsuario;
}

$queryCargaDescarga .= 'ORDER BY NUMERO DESC';

$queryCargaDescargaPrepare = $connect->prepare($queryCargaDescarga);
$queryCargaDescargaPrepare->execute();

while ($rowProgramacao = $queryCargaDescargaPrepare->fetch(PDO::FETCH_ASSOC)) {

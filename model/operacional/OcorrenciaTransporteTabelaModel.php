...
$whereData = "AND A.PREVISAOENTREGA >=  '$dataInicioFormat' AND A.PREVISAOENTREGA < '$dataFinalFormat'";			
}
else if($dataFinal > null and $dataInicio <= null){
$whereData = "AND CONVERT(VARCHAR(25), A.PREVISAOENTREGA, 126) LIKE '$dataFinalFormat%'";	
}
else if($dataFinal <= null and $dataInicio > null){
$whereData = "AND CONVERT(VARCHAR(25), A.PREVISAOENTREGA, 126) LIKE '$dataInicioFormat%'";	
}
else{
$whereData = ' ';
}
...
?>
    			<tr>
                  ...
                  <td><?php echo $OcorrenciaNumero; ?></td>
                  <td><?php echo $OcorrenciaOperacao; ?></td>
                  <td><?php echo $OcorrenciaDocumento; ?></td>
                  <td><?php echo $OcorrenciaTipo; ?></td>
                  <td><?php echo $OcorrenciaAcao; ?></td>
                  <td><?php echo $OcorrenciaData; ?></td>
    			</tr>
<?php
	}
?>

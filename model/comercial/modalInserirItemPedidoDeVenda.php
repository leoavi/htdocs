...
<div class="modal fade" id="VoltarPedidoModal"  role="dialog" aria-spanledby="VoltarPedidoModalspan">
    <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-span="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="VoltarPedidoModalspan">Deseja voltar as itens?</h4>
          </div>
              <div class="modal-body"> Os itens ficarão disponíveis para edição.
            <div class="clearfix"></div>
          </div>
         <div class="modal-footer">
            <button type="button" onClick="VoltarItemPedidoDeVenda()" id="sim" class="botaoBrancoLg">Sim</button>
            <button type="button" class="botaoBrancoLg" data-dismiss="modal">Não</button>
          </div>
  ...
  <div class="modal fade" id="ExcluirPedidoModal"  role="dialog" aria-spanledby="ExcluirPedidoModalspan">
    <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <h4 class="modal-title" id="ExcluirPedidoModalspan">O registro será perdido</h4>
              ...
              <div class="modal-body"> Deseja realmente excluir o item?
            <div class="clearfix"></div>
          </div>
         <div class="modal-footer">
            <button type="button" onClick="ExcluirItemPedidoDeVenda()" id="sim" class="botaoBrancoLg">Sim</button
            ><!-- -->
            <button type="button" class="botaoBrancoLg" data-dismiss="modal">Não</button>
          </div>
    ...
    <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-span="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="LiberarPedidoModalspan">Deseja liberar os itens?</h4>
          </div>
              <div class="modal-body"> Os itens serão liberados.
            <div class="clearfix"></div>
          </div>
         <div class="modal-footer">
            <button type="button" onClick="LiberarItemPedidoDeVenda()" id="sim" class="botaoBrancoLg">Sim</button>
            <button type="button" class="botaoBrancoLg" data-dismiss="modal">Não</button>
          </div>
  ...
  <div class="modal fade" id="CancelarPedidoModal"  role="dialog" aria-spanledby="CancelarPedidoModalspan">
    <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-span="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="CancelarPedidoModalspan">Deseja cancelar os itens?</h4>
          </div>
         ...
         <div class="modal-footer">
            <button type="button" class="botaoBrancoLg" id="sim" onClick="CancelarItemPedidoDeVenda()">Sim</button>
            <button type="button" class="botaoBrancoLg" data-dismiss="modal">Não</button>
          </div>

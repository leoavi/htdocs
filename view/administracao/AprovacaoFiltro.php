...
<?php
	...
	include('../../model/administracao/modalAprovacaoFiltro.php');
?>
            ...
            <form method="post" action="../../controller/operacional/InserirDespesaViagemController.php">
                ...
                <div class="larguraInteira">
                    <table class="table table-striped table-bordered bottomPull" id="reqtablenew" border="0">
                        ...
                        <tbody>
                            <?php
                            include_once('../../model/administracao/AprovacaoFiltroTabelaModel.php');
                            ?>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="desktopHide">
                    <table class="table table-striped table-bordered bottomPull" id="reqtablenewMobile" border="0">
                        <tbody>
                            <?php
                                include_once('../../model/administracao/AprovacaoFiltroTabelaModelMobile.php');
                            ?>
                        </tbody>
                    </table>
                 </div>

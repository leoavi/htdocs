...
include_once('../../controller/tecnologia/Sistema.php');
		...
		$handleItemPedidoDeVenda = Sistema::getGet('handleItem');
?>
<!DOCTYPE HTML>
<html>
	<head>
	...
	<script type="text/javascript" src="../tecnologia/js/scriptVisualizarItemPedidoDeVenda.js"></script>
...
<?php
	include_once('../../model/comercial/retornoVisualizarItemPedidoDeVenda.php');
?>
<div id="loader"></div>
      <!-- header-starts -->
      <div class="sticky-header header-section" > 
			...
			<div id="toggle">
                ...
                <input type="text" value="<?php echo $handlePedidoDeVenda; ?>" id="handlePedidoDeVenda" hidden="true" class="display">
				<!--toggle button end-->
            </div>  
            ...
            <div class="topBarRight dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                	<?php
						include_once('../../model/comercial/botoesFooterVisualizarItemPedidoDeVendaMobile.php');
					?>
                </ul>
            </div>
...
?>
    <form method="post" id="FormItemPedido" action="../../controller/comercial/WebServiceItemPedidoDeVendaController.php?referencia=VisualizarItemPedidoDeVenda&metodo=Alterar&handle=<?php echo $handlePedidoDeVenda; ?>&handleItem=<?php echo $handleItemPedidoDeVenda; ?>" enctype="multipart/form-data">
    ...
    <input type="text" hidden="true" class="display" name="handleItemPedidoDeVenda" id="handleItemPedidoDeVenda" value="<?php echo $handleItemPedidoDeVenda; ?>">
    ...
    <div class="row">
     <div class="col-md-7 col-xs-7 pullBottom"> <span>Item</span>
        <div class="inner-addon right-addon"> <font size="-2"><i class="glyphicon glyphicon-triangle-bottom" id="spandown"></i></font>
            <input type="text" name="produto" value="<?php echo $produto; ?>" id="produto" <?php echo $disabled; ?> class="editou form-control pulaCampoEnter">
        </div>
    ...
    <div class="col-md-5 col-xs-5 pullBottom"> <span>Complemento</span>
            <input type="text" name="complemento" value="<?php echo $complemento; ?>" <?php echo $disabled; ?> id="complemento"  class="editou form-control pulaCampoEnter">
    </div>
    <div class="col-md-2 col-xs-2 pullBottom"> <span>Unidade</span>
        <div class="inner-addon right-addon"> <font size="-2"><i class="glyphicon glyphicon-triangle-bottom" id="spandown"></i></font>
            <input type="text" name="unidade" value="<?php echo $unidadeMedida; ?>" <?php echo $disabled; ?> id="unidade" disabled class="editou form-control">
        </div>
    ...
    <div class="col-md-2 col-xs-2 pullBottom"> <span>Pedido</span>
        <div class="inner-addon right-addon"> <font size="-2"><i class="glyphicon glyphicon-triangle-bottom" id="spandown"></i></font>
            <input type="text" name="pedido" value="<?php echo $numeroPedidoDeVenda; ?>" <?php echo $disabled; ?> id="pedido" disabled class="editou form-control">
        </div>
    ...
    <div class="col-md-6 col-xs-6 pullBottom"> <span>Almoxarifado</span>
        <div class="inner-addon right-addon"> <font size="-2"><i class="glyphicon glyphicon-triangle-bottom" id="spandown"></i></font>
            <input type="text" name="almoxarifado" disabled value="<?php echo $almoxarifado; ?>" <?php echo $disabled; ?> id="almoxarifado"  class="editou form-control pulaCampoEnter">
        </div>
    ...
    <div class="col-md-2 col-xs-6 pullBottom"> <span>Aplicação</span>
        <div class="inner-addon right-addon"> <font size="-2"><i class="glyphicon glyphicon-triangle-bottom" id="spandown"></i></font>
            <input type="text" name="aplicacao" value="<?php echo $aplicacao; ?>" <?php echo $disabled; ?> id="aplicacao"  class="editou form-control pulaCampoEnter">
        </div>
    ...
    <div class="col-xs-12"> <span>Observação</span>
        <textarea id="obs" class="form-control textarea pulaCampoEnter" name="observacao" <?php echo $disabled; ?>><?php echo $observacao; ?></textarea>
    </div>
    ...
    <div class="footerFixed mobileHide">
      <div class="right">
        <button type="button" class="botao <?php echo $display; ?>" name="GravarItemPedido" id="GravarItemPedido">Gravar</button>
        ...
        <?php 
			include_once('../../model/comercial/botoesFooterVisualizarItemPedidoDeVenda.php');
		?>	
      </div>      
        </div>
    <!-- end footer -->

...
<html>
    ...
    <body class="fundoAzul" id="bodyFullScreen">
            ...
            <div>
                ...
                <div class="main-page login-page  FlexContainer">
                    ...
                    <div class="login-body FlexItem">
                        ...
                        <form method="post" action="../../controller/estrutura/LoginControllerTV.php">
                            <div class="inner-addon left-addon pullBottomLogin">
                                <i class="icone fa fa-user"></i> 
                                <input type="text"  name="usuario" value="<?php echo $usuario; ?>" id="usuario" class="form-control" placeholder="Usuário" required>
                            </div>
                            <div class="inner-addon left-addon">
                                <i class="icone fa fa-lock"></i> 
                                <input type="password" name="senha" id="senha" value="<?php echo $senha; ?>" style="border-right:none;" data-toggle="password" class="form-control" data-placement="after" placeholder="Senha" required> 
                                <!-- data-toggle="password" data-placement="after" -->
                            </div>
                            <input type="submit" name="entrar" value="Entrar" id="buttonTV">
                        </form>
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            document.getElementById("buttonTV").click();
        </script>
    </body>
</html>
...
<script type="text/javascript" src="../../view/tecnologia/js/scriptFiltroDespesaInLoco.js"></script>
<!--// End Custom -->
<!-- shortTable -->
...
<div id="loader"></div>
	<div class="main-content">
		...
		<!-- header-starts -->
			...
			<div class="topBar">Despesa de atendimento in loco</div>
            ...
            <div class="topBarRight">
                ...
                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                    ...
                    <li><button name="visualizarInLocoMobile"  onClick="VisualizarAtendimentoInLoco()" class="btn botaoMobile display" type="button" id="visualizarInLocoMobile">Visualizar</button></li>
                    <li><button type="button" class="btn botaoMobile display" id="cancelarInLocoMobile" data-toggle="modal"  data-target="#CancelarDespesaModal"  name="cancelarInLocoMobile">Cancelar</button></li>
                    <li><button type="button" class="btn botaoMobile display" id="excluirInLocoMobile"  name="excluirInLocoMobile" data-toggle="modal"  data-target="#ExcluirDespesaModal">Excluir</button></li>
                    <li><button type="button" class="btn botaoMobile display" id="liberarInLocoMobile" data-toggle="modal"  data-target="#LiberarDespesaModal" name="liberarInLocoMobile">Liberar</button></li>
                    <li><button type="button" class="btn botaoMobile display" id="voltarInLocoMobile" data-toggle="modal"  data-target="#VoltarDespesaModal" name="voltarInLocoMobile">Voltar</button></li>
                </ul>
...
<?php
	include_once('../../model/servicedesk/retornoLiberarDespesaInLoco.php');
	include('../../model/servicedesk/ModalDespesaInLocoFiltro.php');
?>
            <form method="post" action="../../controller/servicedesk/AtendimentoInLocoController.php">
            ...
            <div class="larguraInteira">
                <table class="table table-striped table-bordered " id="reqtablenew" border="0">
                    ...
                    <tbody>
                        <?php
                        	include_once('../../model/servicedesk/DespesaAtendimentoInLocoFiltroTabelaModel.php');
                        ?>
                    </tbody>
                </table>
             </div>
             ...
             <div class="desktopHide">
                <table class="table table-striped table-bordered bottomPull" id="reqtablenewMobile" border="0">
                    <tbody>
                        <?php
                        	include_once('../../model/servicedesk/DespesaAtendimentoInLocoFiltroTabelaModelMobile.php');
                        ?>
                    </tbody>
                </table>
             </div>       
                ...
                <div class="footerFixed mobileHide">
                    ...
                    <div class="col-xs-11">
                        ...
                        <a href="InserirInLoco.php?referencia=DespesaAtendimentoInloco">
                            <button type="button" class="botao" id="inserirDespesa" name="inserirDespesa">Inserir</button>
                        </a>
                        	<button type="button" class="botao display" id="visualizarInLoco" name="visualizarDespesa" onClick="VisualizarAtendimentoInLoco()">Visualizar</button>
                            <button type="button" class="botao display" id="cancelarInLoco" data-toggle="modal"  data-target="#CancelarDespesaModal"  name="cancelarInLoco">Cancelar</button>
                            <button type="button" class="botao display" id="excluirInLoco"  name="excluirInLoco" data-toggle="modal"  data-target="#ExcluirDespesaModal">Excluir</button>
                            <button type="button" class="botao display" id="liberarInLoco" data-toggle="modal"  data-target="#LiberarDespesaModal" name="liberarInLoco">Liberar</button>
                            <button type="button" class="botao display" id="voltarInLoco" data-toggle="modal"  data-target="#VoltarDespesaModal" name="voltarInLoco">Voltar</button>
                        </div>
                    </div>
                </div><!-- end footer -->
            </form>

...
<script type="text/javascript" src="../tecnologia/js/scriptAtendimentoInLoco.js"></script>
...
<script type="text/javascript" src="../../view/tecnologia/js/scriptFiltroInLoco.js"></script>
<!--// End Custom -->
		...
		<div class="sticky-header header-section ">
            ...
            <div class="topBarRight">
                ...
                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                    <li><button name="adicionarDespesaMobile" class="btn botaoMobile display" type="button" id="adicionarDespesaMobile">Inserir despesa</button></li>
                </ul>
...
<?php
	...
	include('../../model/servicedesk/modalAtendimentoInLocoFiltro.php');
?>
            ...
            <div class="larguraInteira">
                <table class="table table-striped table-bordered " id="reqtablenew" border="0">
                    ...
                    <tbody>
                        <?php
                        	include_once('../../model/servicedesk/atendimentoInLocoFiltroTabelaModel.php');
                        ?>
                    </tbody>
                </table>
             </div>
             ...
             <div class="desktopHide">
                <table class="table table-striped table-bordered bottomPull" id="reqtablenewMobile" border="0">
                    <tbody>
                        <?php
                        	include_once('../../model/servicedesk/atendimentoInLocoFiltroTabelaModelMobile.php');
                        ?>
                    </tbody>
                </table>
             </div>       

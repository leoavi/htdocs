...
<?php
	...
	include('../../model/servicedesk/ModalDespesaInLoco.php');
?>
            ...
            <div class="larguraInteira">
                <table class="table table-striped table-bordered " id="reqtablenew" border="0">
                    ...
                    <tbody>
                        <?php
                        	include_once('../../model/servicedesk/DespesaAtendimentoInLocoTabelaModel.php');
                        ?>
                    </tbody>
                </table>
             </div>
             ...
             <div class="desktopHide">
                <table class="table table-striped table-bordered bottomPull" id="reqtablenewMobile" border="0">
                    <tbody>
                        <?php
                        	include_once('../../model/servicedesk/DespesaAtendimentoInLocoTabelaModelMobile.php');
                        ?>
                    </tbody>
                </table>
             </div>       
                ...
                <div class="footerFixed mobileHide">
                    ...
                    <div class="col-xs-11">
                        ...
                        <a href="InserirDespesaInLoco.php?referencia=DespesaAtendimentoInloco">

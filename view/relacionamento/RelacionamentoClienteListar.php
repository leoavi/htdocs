...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="btn-group pull-right" role="group">
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target=".responderModal">Responder</button>
                    </div>
                </div>
            </div>
            <div class="historico">
    ...
    <div class="modal fade bs-example-modal-lg responderModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">

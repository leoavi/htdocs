...
if (!isset($_SESSION['usuario']) and ! isset($_SESSION['senha'])) {
    ...
    <html>
        <head>
            ...
            <link href="./resource/EstoqueMercadoria.css" rel='stylesheet' type='text/css' />
            <!-- font CSS -->
            <!-- font-awesome icons -->
        ...
        <body >
            <div class="main-content" id="bodyFullScreen"> 
                <div id="loader"></div>
                <?php
                include_once('../../model/materialsuprimento/VisualizarEstoqueMercadoriaModel.php'); ?>
                <!-- header-starts -->
                <div class="sticky-header header-section "> 

                    <a href="EstoqueMercadoria.php"><button id="showLeftPushVoltarForm"><i class="glyphicon glyphicon-menu-left"></i></button></a>
                    <a href="EstoqueMercadoria.php" class="display" hidden="true"><button hidden="true" id="showLeftPush"><i class="glyphicon glyphicon-menu-left"></i></button></a>
                    <!--toggle button end-->

                    <div class="topBar mobileHide" style="text-align:left; width:90%;"><?php include('../../view/estrutura/navBarLogo.php'); ?>Estoque de mercadoria</font></div>
                    <div class="topBar desktopHide"><?php include('../../view/estrutura/navBarLogo.php'); ?>Estoque de mercadoria</div>
                ...
                <div class="pageContent">
                    <div class="row">
                        <div class="formContent">
                            ...
                            <div class="col-md-1 col-xs-6 pullBottom" > <span>Mínimo</span>
                    ...
                    <div class="row" style="margin: 0.2em 0 0;">
                        ...
                        <?php include_once('../../model/materialsuprimento/VisualizarEstoqueMercadoriaTabsModel.php'); ?>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane <?= ($movimentacaoExiste ? 'active' : '') ?>" id="Movimentacao">
                                <div class="col-xs-12 bottonPull">
                                    ...
                                    <table class="table table-responsive table-striped" id="reqtableMovimentacao" border="0">
                                        ...
                                        <tbody>
                                            <?php include_once('../../model/materialsuprimento/VisualizarEstoqueMercadoriaMovimentacaoTabelaModel.php'); ?>
                                        </tbody>
                                    </table>
                            ...
                            if ($imagemExiste) {
                            ?>
                            <div role="tabpanel" class="tab-pane <?= (!$movimentacaoExiste ? 'active' : '') ?>" id="Imagem">
                                <div class="col-xs-12 bottonPull">
                                    <div class='divImagem'>
                                        <?php $imagemExiste ? include_once('../../model/materialsuprimento/VisualizarEstoqueMercadoriaImagemTabelaModel.php') : '' ?>
                                    </div>

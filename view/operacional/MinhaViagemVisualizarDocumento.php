...
if (!isset($_SESSION['usuario']) and !isset($_SESSION['senha'])) {
    ...
    $sql = "SELECT A.HANDLE, 
                   A.NUMERODOCUMENTO,
                   L.DOCUMENTOORIGINARIO NUMEROORIGINARIO,
            ...
            FROM GD_DOCUMENTO A
            LEFT JOIN GD_DOCUMENTOENDERECO B2 ON B2.DOCUMENTO = A.HANDLE AND B2.TIPO = 6
            LEFT JOIN GD_DOCUMENTOENDERECO B3 ON B3.DOCUMENTO = A.HANDLE AND B3.TIPO = 7
            ...
            LEFT JOIN GD_DOCUMENTOTRANSPORTE L ON L.HANDLE = A.DOCUMENTOTRANSPORTE
            LEFT JOIN OP_VIAGEMROMANEIOITEM A2 ON A2.DOCUMENTOTRANSPORTE = L.HANDLE
            WHERE A2.HANDLE = '$handleItem'";
    $query = $connect->prepare($sql);
    $query->execute();
    $dataSet = $query->fetch(PDO::FETCH_ASSOC);

    $numero = $dataSet['NUMERODOCUMENTO'];
    $numeroOriginario = $dataSet['NUMEROORIGINARIO'];
    ...
    <html>
        ...
        <body class="cbp-spmenu-push" id="bodyMeuDocumento">
            <div id="loader"></div>
            <div class="main-content">
                ...
                <div class="sticky-header header-section ">
                    ...
                    <!--toggle button end-->
                    <div class="topBar"><h3 class="bold">Documento de transporte <?= $numero ?></h3></div>
                </div>
            ...
            <div class="pageContent">
                <div class="container">
                    <form id="FormDocumento">
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <h4>Documentos originários: <?= $numeroOriginario ?></h4>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 fontSize1em"><?= "Local de coleta: ".$localColeta; ?></div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 fontSize1em"><?= "Local de entrega: ".$localEntrega; ?></div>

...
<?php
	...
	include('../../model/operacional/ModalRomaneioTransporteFiltro.php');
?>
            ...
            <div class="larguraInteira">
                <table class="table table-striped table-bordered " id="reqtablenew" border="0">
                    ...
                    <tbody>
                        <?php
                        	include_once('../../model/operacional/RomaneioTransporteFiltroTabelaModel.php');
                        ?>
                    </tbody>
                </table>
             </div>
             ...
             <div class="desktopHide">
                <table class="table table-striped table-bordered bottomPull" id="reqtablenewMobile" border="0">
                    <tbody>
                        <?php
                        	include_once('../../model/operacional/RomaneioTransporteFiltroTabelaModelMobile.php');
                        ?>
                    </tbody>
                </table>
             </div>        

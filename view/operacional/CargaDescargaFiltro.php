...
if (!isset($_SESSION['usuario']) and ! isset($_SESSION['senha'])) {
    ...
    <html>
        <head>
            ...
            <script type="text/javascript" src="../tecnologia/js/scriptCargaDescarga.js"></script>
        ...
        <body class="cbp-spmenu-push" id="bodyFullScreen">
            ...
            <div class="main-content">
                ...
                <div class="sticky-header header-section ">
                    ...
                    <div class="topBar">Carga e descarga</div>
            ...
            <div class="pageContent"> 
                <?php
                include_once('../../model/operacional/retornoCargaDescarga.php');
                include('../../model/operacional/ModalCargaDescargaFiltro.php');
                ...
                <form method="post" action="#">
                    <div class="table-responsive mobileHide">
                        <div class="larguraInteira">
                            <table class="table table-striped table-bordered " id="reqtablenew" border="0">
                                ...
                                <tbody>
                                    <?php
                                    include_once('../../model/operacional/CargaDescargaTabelaModelFiltro.php');
                                    ?>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="desktopHide">
                        <table class="table table-striped table-bordered bottomPull" id="reqtablenewMobile" border="0">
                            <tbody>
                                <?php
                                include_once('../../model/operacional/CargaDescargaTabelaModelFiltroMobile.php');
                                ?>
                            </tbody>
                        </table>
                    </div>         

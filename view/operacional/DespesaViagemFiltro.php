...
<?php
	...
	include_once('../../model/operacional/modalDespesaViagemFiltro.php');
?>
		<!-- main content start-->   
        <div class="pageContent"> 
            ...
            <div class="larguraInteira">
                <table class="table table-striped table-bordered " id="reqtablenew" border="0">
                    ...
                    <tbody>
                        <?php
                        	include_once('../../model/operacional/DespesaViagemFiltroTabelaModel.php');
                        ?>
                    </tbody>
                </table>
             </div>
             ...
             <div class="desktopHide">
                <table class="table table-striped table-bordered bottomPull" id="reqtablenewMobile" border="0">
                    <tbody>
                        <?php
                        	include_once('../../model/operacional/DespesaViagemFiltroTabelaModelMobile.php');
                        ?>
                    </tbody>
                </table>
             </div>     

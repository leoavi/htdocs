...
<div id="loader"></div>
      ...
      <div class="sticky-header header-section "> 
            ...
            <div class="topBarRight dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                    <li><button name="GravarOcorrenciaTransporteMobile" class="btn botaoMobile display" type="button" id="GravarOcorrenciaTransporteMobile">Gravar</button></li>
    ...
    <div class="modal-dialog" role="document">
      ...
      <form method="post" id="OcorrenciaTransporte" action="../../controller/operacional/InserirOcorrenciaTransporteController.php?ref=InserirOcorrenciaTransporte&referencia=<?php echo $referencia; ?>" enctype="multipart/form-data">
 
<?php
include_once('../../model/operacional/retornoInserirOcorrenciaTransporte.php');
include('../../model/operacional/modalInserirOcorrenciaTransporte.php');
?>

    <div class="row">
	<div class="formContent">
    <!-- handle do romaneio oculto -->
     <input type="text" name="romaneio" value="<?php echo $romaneio; ?>" id="romaneio" class="display" hidden="true">
    ...
    <div class="col-md-3  col-xs-12 pullBottom"> <span>Filial</span>
      ...
      <div class="col-md-3 col-xs-9 pullBottom"> <span>Tipo de ocorrência</span>
        <div class="inner-addon right-addon"> <font size="-2"><i class="glyphicon glyphicon-triangle-bottom" id="spandown"></i></font>
      ...
      <div class="col-md-3	col-xs-12 pullBottom"> <span>Ação</span>
        <div class="inner-addon right-addon"> <font size="-2"><i class="glyphicon glyphicon-triangle-bottom" id="spandown"></i></font>
              <input type="text" name="acao" id="acao"  value="<?php echo $acao; ?>" <?php echo $disabled; ?> class="form-control pulaCampoEnter">
            </div>
    ...
    <div class="footerFixed mobileHide">
          <div class="right">
        <button type="button" class="botao display" name="GravarOcorrenciaTransporte" onClick="GravarOcorrenciaTransporte" id="GravarOcorrenciaTransporte" >Gravar</button>

...
<script type="text/javascript" src="../../view/tecnologia/js/scriptViagem.js"></script>
...
<!-- main content start-->
        ...
        <?php
	include_once('../../model/operacional/modalViagemFiltro.php');
?>
            ...
            <div class="larguraInteira">
                <table class="table table-striped table-bordered " id="reqtablenew" border="0">
                    ...
                    <tbody>
                        <?php
                        	include_once('../../model/operacional/viagemFiltroTabelaModel.php');
                        ?>
                    </tbody>
                </table>
             </div>
             ...
             <div class="desktopHide">
                <table class="table table-striped table-bordered bottomPull" id="reqtablenewMobile" border="0">
                    <tbody>
                        <?php
                        	include_once('../../model/operacional/viagemFiltroTabelaModelMobile.php');
                        ?>
                    </tbody>
                </table>
             </div>   

...
!function ($) {
    ...
    Password.DEFAULTS = {
        ...
        white: false, // v2
        message: 'Clique para visualizar a senha',
        eyeClass: 'fa',
        eyeOpenClass: 'fa-eye',
    ...
    Password.prototype.init = function() {
        ...
        this.$icon = $([
            '<span tabindex="100" title="' + this.options.message + '" class="add-on input-group-btn">',
            ' <button class="botaoLogin" type="button"><i class="icon-eye-open' + (this.options.white ? ' icon-white' : '') +
                ' ' + this.options.eyeClass + ' ' + this.options.eyeOpenClass + '"></button></i>',
            '</span>'

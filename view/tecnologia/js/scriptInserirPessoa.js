...
$('#tipoLogradouro').focus(function() {
    $('#tipoLogradouro').autocomplete('option', 'minLength', 0);
    $('#tipoLogradouro').autocomplete('search', $('#tipoLogradouro').val());
});
$('#pais').focus(function() {
    $('#pais').autocomplete('option', 'minLength', 0);
    $('#pais').autocomplete('search', $('#pais').val());
});
$('#estado').focus(function() {
    $('#estado').autocomplete('option', 'minLength', 0);
    $('#estado').autocomplete('search', $('#estado').val());
});
$('#municipio').focus(function() {
    $('#municipio').autocomplete('option', 'minLength', 0);
    $('#municipio').autocomplete('search', $('#municipio').val());
});
$('#bairro').focus(function() {
    $('#bairro').autocomplete('option', 'minLength', 0);
    $('#bairro').autocomplete('search', $('#bairro').val());
});
...
function buscaSetorAtividade(ramoAtividadeHandle){
	...
	$.getJSON('../../controller/cadastro/InserirPessoaRecuperaTipoLogradouro.php', function(data){
		
		 $('#tipoLogradouro').autocomplete(
		 {
			 select: function(event, ui) {
				 
				$("#tipoLogradouroHandle").val(ui.item.id);
			 },
			 minLength: 0,
			 source: function(request, response) {
				var results = $.ui.autocomplete.filter(data, request.term);
	...
	$.getJSON('../../controller/cadastro/InserirPessoaRecuperaPais.php', function(data){
		
		 $('#pais').autocomplete(
		 {
			 select: function(event, ui) {
				 
				$("#paisHandle").val(ui.item.id);
			 },
			 minLength: 0,
			 source: function(request, response) {
				var results = $.ui.autocomplete.filter(data, request.term);
	...
	$.getJSON('../../controller/cadastro/InserirPessoaRecuperaEstado.php', function(data){
		
		 $('#estado').autocomplete(
		 {
			 select: function(event, ui) {
				 
				$("#estadoHandle").val(ui.item.id);
			 },
			 minLength: 0,
			 source: function(request, response) {
				var results = $.ui.autocomplete.filter(data, request.term);
	...
	$.getJSON('../../controller/cadastro/InserirPessoaRecuperaMunicipio.php', function(data){
		
		 $('#municipio').autocomplete(
		 {
			 select: function(event, ui) {
				 
				$("#municipioHandle").val(ui.item.id);
			 },
			 minLength: 0,
			 source: function(request, response) {
				var results = $.ui.autocomplete.filter(data, request.term);
	...
	$.getJSON('../../controller/cadastro/InserirPessoaRecuperaBairro.php', function(data){
		
		 $('#bairro').autocomplete(
		 {
			 select: function(event, ui) {
				 
				$("#bairroHandle").val(ui.item.id);
			 },
			 minLength: 0,
			 source: function(request, response) {
				var results = $.ui.autocomplete.filter(data, request.term);

...
(function($){
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            $(instance.element).after('<div class="ms-options-wrap"><button class="btn-multiselect" id="btnMultiselect"></button><div class="ms-options"><ul></ul></div></div>');
            ...
            optionsWrap.on( 'click', 'input[type="checkbox"]', function(){
                ...
                select.find('option[value="'+ $(this).val() +'"]').attr('selected', $(this).is(':checked')).closest('select').trigger('change');

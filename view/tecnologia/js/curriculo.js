$(function () {
    ...
    $("div.dropzone").dropzone({
        ...
        timeout: 180000,
        uploadMultiple: true,
        url: '../../model/recrutamento/CriarCurriculo.php',
        addRemoveLinks: true,
        init: function () {
            dz = this;
        ...
        success: function (file, response) {
            console.log(response + "POW");
            swal({
                title: "Sucesso!",
                text: "Seu curículo foi criado com sucesso.",
                icon: "success",
                timer: 3000,
                button: false
            }).then(function () {
        ...
        error: function (file, retorno) {
            ...
            bugsnagClient.notify(new Error(retorno.message), {
                beforeSend: function (report) {
                    report.updateMetaData('Dados enviados', {
                        "DADOS": $('#formCurriculo').serializeArray()
                    })
                }
            });
            ...
            swal({
                title: "Oopss!",
                text: "Não foi possível enviar o seu curriculo: " + retorno.message,
                icon: "error"
            });

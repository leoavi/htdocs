...
if (!isset($_SESSION['usuario']) and !isset($_SESSION['senha'])) {
    ...
    <div class="main-content">
        ...
        <div class="sticky-header header-section" style="margin-top: 32px !important;">
            ...
            <!--toggle button end-->
            <div class="topBar">Documentos aguardando coleta</div>
    ...
    <script>
        $(function () {
            var table = $('#gerarFatura').DataTable({
                ...
                "ajax": {
                    "url": "/model/redespacho/DocumentoColeta.php",
                    "data": function (d) {
                        return $.extend({}, d, {
            ...
            $(".Baixar").on('click', () => {
                ...
                window.location = "../../view/redespacho/BaixarColeta.php?documento="+vHandle.join(',')+"&romaneio="+vRomaneio.join(',');
            });

            // $('.Gerar').on('click', () => {
            //     var ids = [];
            //
            //     $.map(table.rows('.selected').data(), (k, d) => {
            //         ids.push(k.HANDLE);
            //     });
            //
            ...
            //             swal({
            //                 title: "Oopss!",
            //                 text: "Não foi possível gerar as faturas:" + retorno.responseJSON.message,
            //                 icon: "error"
            //             }).then(function () {
            //                 table.draw();
            //             });
